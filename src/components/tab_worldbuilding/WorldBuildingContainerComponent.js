    ...
    return(
      ...
      {/* Ping the mlab server and get the contents back*/}
            ...
            <div id = "Introduction">
              ...
              An Atomcrafted tool will be comprised of modular components, constantly shifting to match the whims of the user who forged them. A firearm 
              made from Extradimensional Matter will cycle through different firing modes depending on the skill of the user that crafted those components.   </p>
             
              <table className="image">
                <tr><td> <img src="https://66.media.tumblr.com/b9031267e0839b004b03fbc1dfb5c887/tumblr_perfuuBA3h1qgojgxo2_540.gif"></img></td></tr>
                <tr><td className="caption">Preview pic from the game Control (2019) WIP weapon test. This is an approximation of what a modern (3rd, 4th generation)
                Atomancer can do with enough time and practice </td></tr>
              </table>
            <br/>
              <p>
